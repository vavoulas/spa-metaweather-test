  ...
  return (
    <div className="weather container">
      ...
      <form className="mb-3" onSubmit={(e) => locationData(e)}>
        <label for="Location" className="form-label h4 text-muted">
          Location
        </label>
        <div className="d-flex justify-content-center">
          ...
          <button
            type="submit"
            className="btn btn-success py-2 mx-2 btn-lg"
          ...
          <ul className="list-group ">
            {locData.map((place) => (
              <div>
                ...
                key="place.woeid"
                onClick={(e)=> weatherDisplay(e)}>
                {place.title}
                </button>
                <DisplayWeather city={place.title} id={place.woeid} condition={condition}/>
